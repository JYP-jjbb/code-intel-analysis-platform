...
# Resolve repo root as 4 levels up from this file:
#   checker/checker_bridge/tracing/utils.py -> checker/checker_bridge/tracing/ -> checker/checker_bridge/ -> checker/ -> repo root
_REPO_ROOT = pathlib.Path(__file__).resolve().parent.parent.parent.parent
AGENT_LD_PATH = str(_REPO_ROOT / 'libs')
GEN_AND_TRACE_JAR = str(_REPO_ROOT / 'libs' / 'GenAndTrace.jar')
